...
export default function LoginPage() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // TRIGGER THE HYPER-SPEED TRANSITION
      setSuccess(true);
      setTimeout(() => {
  ...
  return (
    <div className="min-h-screen bg-[#09090b] flex items-center justify-center relative overflow-hidden font-sans p-6">
      ...
      <div className="absolute top-[-20%] left-[-10%] w-[70vw] h-[70vw] bg-indigo-600/20 rounded-full blur-[150px] pointer-events-none mix-blend-screen animate-pulse duration-1000"></div>
      <div className="absolute bottom-[-20%] right-[-10%] w-[60vw] h-[60vw] bg-fuchsia-600/10 rounded-full blur-[150px] pointer-events-none mix-blend-screen"></div>

      {/* SUCCESS OVERLAY WIPE */}
      <div className={`absolute inset-0 bg-indigo-600 z-50 flex items-center justify-center transition-transform duration-1000 ease-in-out ${success ? 'translate-y-0' : 'translate-y-full'}`}>
         <div className="text-white flex flex-col items-center">
            <Activity className="w-16 h-16 animate-pulse mb-4" />
            <h2 className="text-3xl font-black tracking-widest uppercase">Connecting...</h2>
         </div>
      </div>
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="flex flex-col items-center justify-center mb-10">
          <div className="bg-gradient-to-br from-indigo-500 to-fuchsia-500 p-3 rounded-2xl shadow-lg shadow-indigo-500/20 mb-4 transform transition-transform hover:scale-110">
          ...
          <p className="text-gray-400 font-medium text-sm text-center">
            Sign in to manage your subscriptions and view AI insights.
          </p>
        </div>
        ...
        <div className="bg-white/5 backdrop-blur-2xl border border-white/10 rounded-3xl p-8 shadow-2xl relative overflow-hidden">
          <form className="space-y-6 relative z-10" onSubmit={handleLogin}>
              ...
              <div>
                ...
                <div className="relative group">
                  ...
                  <input
                    type="email"
                    required
                    className="w-full pl-11 pr-4 py-3.5 bg-black/50 border border-white/10 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 text-white placeholder-gray-600 outline-none transition-all"
            ...
            <button
              ...
              className={`w-full flex items-center justify-center space-x-2 py-4 rounded-xl text-sm font-black transition-all duration-300 shadow-[0_0_20px_rgba(99,102,241,0.2)] disabled:opacity-80
            ...
            >
              {success ? (
                ...
                <><Activity className="w-4 h-4" /><span>Sign In</span></>
              )}
            </button>
          </form>
