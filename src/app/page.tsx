...
export default function LandingPage() {
  ...
  return (
    // Outer wrapper: handles the full screen, flex-layout for the footer, and kills horizontal scroll
    <div className="bg-[#09090b] text-gray-100 font-sans selection:bg-indigo-500/30 relative min-h-screen flex flex-col overflow-x-hidden">
      ...
      {/* ANIMATED BACKGROUND ORBS (Trapped in fixed container to prevent scroll bleed) */}
      <div className="fixed inset-0 pointer-events-none overflow-hidden z-0">
        <div className="absolute top-[-10%] left-[-10%] w-[60vw] h-[60vw] md:w-[40vw] md:h-[40vw] bg-indigo-600/20 rounded-full blur-[120px] md:blur-[150px] mix-blend-screen animate-pulse duration-[3000ms]"></div>
        <div className="absolute top-[20%] right-[-10%] w-[60vw] h-[60vw] md:w-[50vw] md:h-[50vw] bg-fuchsia-600/10 rounded-full blur-[120px] md:blur-[150px] mix-blend-screen"></div>
        <div className="absolute bottom-[-20%] left-[20%] w-[70vw] h-[70vw] md:w-[60vw] md:h-[60vw] bg-indigo-600/10 rounded-full blur-[120px] md:blur-[150px] mix-blend-screen"></div>
      </div>
      ...
      <nav className="border-b border-white/5 bg-black/10 backdrop-blur-md fixed top-0 w-full z-50">
        ...
        {isMobileMenuOpen && (
          <div className="sm:hidden border-t border-white/5 bg-black/80 backdrop-blur-lg px-4 py-4 flex flex-col space-y-3">
            <Link
              href="/login"
      ...
      {/* MAIN CONTENT WRAPPER: flex-grow pushes footer down, flex-col keeps sections tightly stacked */}
      <div className="flex-grow flex flex-col relative z-10 pt-20">
        
        {/* HERO SECTION */}
        <main className="pt-8 pb-16 sm:pt-16 lg:pt-28 lg:pb-32 px-4 sm:px-6">
        ...
        {/* SOCIAL PROOF / STATS */}
        <section className="border-y border-white/5 bg-black/20 backdrop-blur-md py-10">
      ...
      {/* FOOTER (shrink-0 ensures it never gets squished, flex-grow above ensures it sits at the bottom) */}
      <footer className="border-t border-white/5 bg-black/40 pt-12 pb-8 relative z-10 shrink-0">
